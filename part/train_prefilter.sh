#!/bin/bash
# =============================================================================
# Training launch script for TrackPreFilter (Stage 1 pre-filter).
#
# Starts two screen sessions:
#   - "prefilter_train": Training output (train_prefilter.py)
...
#   screen -r prefilter_gpu      # GPU monitoring
#
...
TRAIN_CMD="${CONDA_INIT} && cd ${SCRIPT_DIR} && python train_prefilter.py \
