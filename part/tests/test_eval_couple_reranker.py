...
class TestParquetSchema:
    def test_written_parquet_has_correct_columns(self, tmp_path):
        ...
        results_rows = [
            {
                ...
                'top_256_prefilter_indices': [3, 7, 5, 12],
                'top_256_prefilter_pt': [0.5, 1.2, 0.8, 2.1],
                'top_100_part_indices': [3, 7, 12],
                'top_100_part_pt': [0.5, 1.2, 2.1],
            ...
            },
            {
                ...
                'top_256_prefilter_indices': [1, 2, 8],
                'top_256_prefilter_pt': [0.4, 0.9, 1.5],
                'top_100_part_indices': [1, 2],
                'top_100_part_pt': [0.4, 0.9],
        ...
        expected_columns = {
            ...
            'top_256_prefilter_indices', 'top_256_prefilter_pt',
            'top_100_part_indices', 'top_100_part_pt',
